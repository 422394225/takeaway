...
import core.utils.ReadPackUtils;
...
public class RedPackApiController extends Controller {
	...
	public void sendredpack() {
		...
		boolean isSend = ReadPackUtils.sendredpack(getRequest(), "100", "1", "感谢您参加猜灯谜活动，祝您元宵节快乐！", "猜灯谜抢红包活动",
				"猜越多得越多，快来抢！", "o_pncsidC-pRRfCP4zj98h6slREw", partner, wxappid, sendName, paternerKey, certPath);
	...
	public void sendGroupRedPack() {
		...
		boolean isSend = ReadPackUtils.sendGroupRedPack(partner, wxappid, "天虹百货", "o_pncsidC-pRRfCP4zj98h6slREw", "100",
				"10", "感谢您参加猜灯谜活动，祝您元宵节快乐！", "猜灯谜抢红包活动", "猜越多得越多，快来抢", paternerKey, certPath);
