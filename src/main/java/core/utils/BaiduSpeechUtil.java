...
public class BaiduSpeechUtil {
	...
	private static final String VOICE_PATH = PropKit.get("voicePath");
	...
	public static void main(String[] args) {
		synthesisToFile("你有新订单啦！", "order-2.mp3");
	}
	 ...
	 */
	public static void synthesisToFile(String content, String fileName) {
		// 设置可选参数
	 ...
	 * per String 发音人选择, 0为女声，1为男声，3为情感合成-度逍遥，4为情感合成-度丫丫，默认为普通女 否<br>
	 */
	public static byte[] synthesis(String content) {
		// 设置可选参数
		HashMap<String, Object> options = new HashMap<String, Object>();
		options.put("spd", "5");
		options.put("pit", "5");
